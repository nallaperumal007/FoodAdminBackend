...
')
     ...
     */
        ...
        {
                        return Collection::downloadExcel($fileName, $writerType, $withHeadings, $responseHeaders);
        }
                    /**
         *
         *
        ...
        {
                        return Collection::storeExcel($filePath, $disk, $writerType, $withHeadings);
        }
...
namespace  {
    ...
    use Fomvasss\LaravelMetaTags\Facade;
