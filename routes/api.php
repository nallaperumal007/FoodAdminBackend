...
//    Route::get('/login/{provider}',                 [LoginController::class,'redirectToProvider']);
    ...
    Route::group(['prefix' => 'rest'], function () {
        ...
        /* Shops */
        Route::get('main-shop',                     [Rest\ShopController::class, 'mainShop']);
        Route::get('branch/products',               [Rest\ShopController::class, 'products']);
        ...
        Route::get('main-shop/galleries',            [Rest\ShopController::class, 'mainGalleries']);
        Route::get('main-shop/reviews',              [Rest\ShopController::class, 'mainReviews'])->where('id', '[0-9]+');
        Route::get('main-shop/reviews-group-rating', [Rest\ShopController::class, 'mainReviewsGroupByRating'])->where('id', '[0-9]+');

        Route::get('branch/products/paginate',  [Rest\ProductController::class, 'productsPaginate']);
        Route::get('branch/products/recommended/paginate',  [
        ...
        Route::get('branch/check-smallest',                 [Rest\DeliveryZoneController::class, 'checkSmallest']);
